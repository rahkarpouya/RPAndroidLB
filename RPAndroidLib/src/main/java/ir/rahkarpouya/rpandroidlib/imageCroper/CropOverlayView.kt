...
import ir.rahkarpouya.rpandroidlib.imageCroper.CropImageView.CropShape
import ir.rahkarpouya.rpandroidlib.imageCroper.CropImageView.Guidelines
import java.util.*
import kotlin.math.*
...
@JvmOverloads constructor(
     ...
     * application.
     */
    private var guidelines: Guidelines?
        get() = mGuidelines
        set(guidelines) {
...
// then the image height is the determining initial length. Else, vice-versa.
    ...
    override fun performClick(): Boolean {
        return click && super.performClick()
    }
